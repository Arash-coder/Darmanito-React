            ...
            <form className={style.main} onSubmit={props.formik.handleSubmit}>
                ...
                <div className={[style.grid_item, style.margin].join(' ')}>
                    <div className={style.center}>
                        ...
                        <input id="file" name="pic" type="file" className={style.file} onChange={(event) => {
                ...
                <button className={style.btn} type="submit" onClick={props.formik.isValid ? props.clicked : null}>مرحله بعد</button>
            </form>
        </main>
    );
}
